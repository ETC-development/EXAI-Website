...
const socials: { label: string; href: string; children: ReactNode }[] = [
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/ensia-tech-community",
    children: (
  ...
  {
    label: "Discord",
    href: "https://discord.gg/ZDsjPSYuya",
    children: (
      <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/etc_.club",
    children: (
      <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
  ...
  {
    label: "TikTok",
    href: "https://www.tiktok.com/@etc._.club",
    children: (
      <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
